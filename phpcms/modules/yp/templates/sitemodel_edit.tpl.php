...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type='radio' id="show_menu" name='setting[ismenu]' value='1'<?php if ($setting['ismenu']) {?> checked<?php }?>> ÊÇ&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[ismenu]' id="hide_menu" value='0'<?php if ($setting['ismenu']==0) {?> checked<?php }?>> ·ñ</td>
  </tr>
</table>
</fieldset>
<fieldset id="template_show"<?php if ($setting['ismenu']==0) {?> style="display:none;"<?php }?>>
  ...
  <th width="120"><?php echo L('available_styles');?></th>
		...
		<tr>
        <th width="120"><?php echo L('category_index_tpl')?>£º</th>
	  ...
	  <tr>
        <th width="120"><?php echo L('category_list_tpl')?>£º</th>
        <td  id="list_template">
		</td>
      </tr>
	  <tr>
        <th width="120"><?php echo L('content_tpl')?>£º</th>
        <td  id="show_template">
		</td>
      </tr>
</table>
