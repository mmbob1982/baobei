...
<tbody>
 	<tr>
     <th width="200"><strong><?php echo L('add_category_types');?>£º</strong></th>
      <td>
      ...
      <tr>
        <th><strong><?php echo L('parent_category')?>£º</strong></th>
        <td>
     ...
     <input type="hidden" name="info[modelid]" value="<?php echo $modelid?>">
      <tr>
        <th><strong><?php echo L('catname')?>£º</strong></th>
        <td>
	...
	<tr>
        <th><strong><?php echo L('catgory_img')?>£º</strong></th>
