...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<?php echo L('username')?>£º<input type="text" value="" class="input-text" name="search[username]" size="10"> <input type="submit" value=" <?php echo L('search')?> " class="button" name="search_submit">
