...
<table width="100%" class="table_form ">
		<tr>
		<th width="200"><strong><?php echo L('position_setting')?></strong>£º</th>
	  ...
	  <tr>
        <th width="200"><strong><?php echo L('company_is_check')?></strong>£º</th>
        <td>
      ...
      <tr>
        <th width="200"><strong><?php echo L('is_pay')?></strong>£º</th>
        <td>
      ...
      <tr>
        <th width="200"><strong><?php echo L('enable_rewrite')?></strong>£º</th>
        <td>
	  ...
	  <tr>
        <th width="200"><strong><?php echo L('encode_page_cache')?></strong>£º</th>
        <td>
...
<table width="100%" class="table_form ">
		<tr>
      <th width="200"><strong><?php echo L('yp_title')?></strong>£º<br><?php echo L('title_for_search_engines')?></th>
      <td><input type="text" size="30" name="setting[seo_title]" value="<?php echo $setting['seo_title']?>" id="seo_title" class="input-text"></td>
    </tr>
	<tr>
      <th><strong><?php echo L('yp_keywords')?></strong>£º<br><?php echo L('keyword_for_search_engines')?></th>
      <td><textarea name='setting[seo_keywords]' cols='60' rows='2' id='seo_keywords'><?php echo $setting['seo_keywords']?></textarea></td>
    </tr>
	<tr>
      <th><strong><?php echo L('yp_description')?></strong>£º<br><?php echo L('description_for_search_engines')?></th>
