...
<table cellpadding="2" cellspacing="1" width="98%">
	<tr> 
      <td>菜单ID</td>
      <td><input type="text" id="linkboxsid" name="setting[linkboxsid]" value="<?php echo $setting['linkboxsid'];?>" size="5"> 
	  <input type='button' value="在列表中选择" onclick="omnipotent('selectid','?m=admin&c=linkboxs&a=public_get_list','在列表中选择')" class="button">
	...
	<tr> 
     ...
     <tr> 
      <td>最多添加数量</td>
      <td><input type="text" name="setting[most]" value="<?php echo $setting['most'];?>" size="5" class="input-text">用户最多添加的数据行数</td>
    </tr>        	
</table>
