...
<div id="header">
    ...
    <span class="rt log"><a href="<?php echo siteurl($siteid);?>">Ê×Ò³</a> | <a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=login">µÇÂ¼</a> | <a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=register">×¢²á</a></span>
    </div>
</div>