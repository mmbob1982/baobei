...
<div class="main clear">
    ...
    <div class="col-auto">
    	<div class="box box-tab fillet fillet-blue">
			...
			<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"yp\" data=\"op=yp&tag_md5=44f1081f071b7e1fc8fb417eed97e0db&action=position&posid=%24posid&modelid=%24modelid&order=listorder+ASC&expiration=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$yp_tag = pc_base::load_app_class("yp_tag", "yp");if (method_exists($yp_tag, 'position')) {$data = $yp_tag->position(array('posid'=>$posid,'modelid'=>$modelid,'order'=>'listorder ASC','expiration'=>'1','limit'=>'20',));}?>
				<ul class="list-num">
				<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
					<li><em<?php if($n<4) { ?> class="n<?php echo $n;?>"<?php } ?>><?php echo $n;?></em><a href="<?php echo $categorys_p[$r['catid']]['url'];?>" class="blue">[<?php echo $categorys_p[$r['catid']]['catname'];?>]</a> <a href="<?php echo $r['url'];?>"><?php echo str_cut($r['title'], 30);?></a></li>
				<?php $n++;}unset($n); ?>
				</ul>
			<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
			<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"yp\" data=\"op=yp&tag_md5=f1ed0395daf28ee6683978fcfa0b0b87&action=lists&modelid=.%24modelid&num=10&order=id+DESC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$yp_tag = pc_base::load_app_class("yp_tag", "yp");if (method_exists($yp_tag, 'lists')) {$data = $yp_tag->lists(array('modelid'=>'.$modelid','order'=>'id DESC','limit'=>'10',));}?>
