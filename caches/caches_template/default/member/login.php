...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
    	...
    	<div class="input">
			<label><?php echo L('username');?>£º</label><input type="text" id="username" name="username" size="22" class="input-text">
		</div>
        <div class="input">
			<label><?php echo L('password');?>£º</label><input type="password" id="password" name="password" size="22" class="input-text">
		</div>
        <div class="input">
			<label><?php echo L('checkcode');?>£º</label><input type="text" id="code" name="code" size="8" class="input-text"><?php echo form::checkcode('code_img', '4', '14', 84, 24);?>
		</div>
        <div class="take">
            	...
            	<div class="content">
                    ...
                    <div class="pass-logo">
                        ...
                        <?php if($setting['snda_akey'] || $setting['snda_skey']) { ?>
                        	<li style="margin-right:14px;"><a href="javascript:;" onclick="show_login('snda');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/snda_16_16.png)">Ê¢´óÍ¨ÐÐÖ¤</a></li>
                        <?php } ?>
                        <?php if($setting['sina_akey'] || $setting['sina_skey']) { ?>
                            <li><a href="javascript:;" onclick="show_login('sina');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/sina_16_16.png)">ÐÂÀËÎ¢²©µÇÂ¼</a></li>
                        <?php } ?>

						<?php if($setting['qq_akey'] || $setting['qq_skey']) { ?>
                        	<li style="margin-right:14px;"><a href="javascript:;" onclick="show_login('qq');return false;" style="background-image:url(<?php echo IMG_PATH;?>member/logo/qq_16_16.png)">ÌÚÑ¶Î¢²©µÇÂ¼</a></li>
						<?php } ?>
						<?php if($setting['qq_appkey'] || $setting['qq_appid']) { ?>
                        	<li style="margin-right:14px;"><a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=public_qq_loginnew" target="_blank" style="background-image:url(<?php echo IMG_PATH;?>member/logo/qq_16_16.png)">ÌÚÑ¶QQµÇÂ¼</a></li>
						<?php } ?>
                        </ul>
                        <p>
