...
<body>
<div id="header">
	<div class="logo"><a href="<?php echo $siteinfo['domain'];?>"><img src="<?php echo IMG_PATH;?>v9/logo.jpg" height="60" /></a><h3>商务中心</h3></div>
    ...
    <div class="link">您好！ <?php echo get_nickname();?><span> | </span><a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=logout">退出</a><span> | </span><a href="<?php echo $siteinfo['domain'];?>">网站首页</a><span> | </span><a href="<?php echo COMPANY_URL;?>" class="f12 fn home blue" target="_blank">我的主页</a></div>
	<div class="nav-bar">
    	<map>
