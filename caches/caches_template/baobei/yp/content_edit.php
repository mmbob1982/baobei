...
<div id="memberArea">
	...
	<div class="col-auto">
		<div class="col-1 ">
			...
			<form method="post" action="?m=yp&c=business&a=content&action=edit&modelid=<?php echo $modelid;?>" id="myform" name="myform">
				<table width="100%" cellspacing="0" class="table_form">
					<?php include template('yp', 'content_brand'); ?>
...
function get_additional(obj) {
	...
	var catid = obj.value;
	$.get('<?php echo APP_PATH;?>index.php', {m:'yp', c:'business', a:'content', action:'get_addition', modelid:modelid, catid:catid, id:<?php echo $id;?>,time:Math.random()}, function (data) {
		if (data) {
			var obj = eval( "(" + data + ")" );
			var string = '';
			for (var one in obj) {
